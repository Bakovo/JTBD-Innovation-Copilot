...
1. 以用户任务为中心 —— 所有分析从用户想完成的 Job 出发，而非产品功能
2. 不从产品方案出发 —— 用户提出的解决方案不等于真实需求
3. 关注结果，而非功能 —— 用户雇佣产品是为了达成某个结果
4. 证据驱动 —— 所有洞察必须有用户数据支持，可追溯
5. 区分维度 —— 同时考虑功能、社会、情感三个维度
...
| 维度 | 权重 | 范围 |
|------|------|------|
| 用户重要性（User Importance） | 1.5x | 1–10 |
| 不满意度（Dissatisfaction） | 1.3x | 1–10 |
| 发生频率（Frequency） | 1.2x | 1–10 |
| 市场规模（Market Size） | 1.0x | 1–10 |
| 商业价值（Business Value） | 1.0x | 1–10 |
| 战略契合（Strategic Fit） | 0.8x | 1–10 |
| 技术可行性（Technical Feasibility） | 0.7x | 1–10 |
...
1. **Evidence Checker** —— 验证每个洞察是否引用了具体证据
2. **JTBD Quality Checker** —— 5T 原则质量门禁
3. **Hallucination Checker** —— 检测无用户数据支持的 AI 幻觉
4. **Confidence Score** —— 基于证据强度、多样性、来源质量的置信度评分
...
| 7 | Need Analysis | 结构化输出 |
| 8 | Desired Outcomes | 结构化输出 |
